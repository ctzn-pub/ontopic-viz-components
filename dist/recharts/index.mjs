import { ResponsiveContainer, LineChart, CartesianGrid, XAxis, YAxis, Tooltip, Line, ErrorBar, BarChart, Legend, Bar, Brush, ReferenceArea, Text, ScatterChart, Scatter, ComposedChart, ZAxis, Area, ReferenceLine } from 'recharts';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import React5, { useState, useRef, useEffect, useMemo } from 'react';
...
import { Users, ArrowUpDown, ChevronUp, ChevronDown, Palette, DollarSign, UserCircle2, GraduationCap } from 'lucide-react';
...
function AbortionOpinionChart({ data }) {
  ...
  const groupedData = React5.useMemo(() => {
    const groups = {};
...
var LineChart3 = ({ data = [] }) => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const errorBarsPlot = Plot2.plot({
...
var DualAxisChart = ({
  ...
  const yAxis1Domain = React5.useMemo(() => {
  ...
  const yAxis2Domain = React5.useMemo(() => {
    if (!filteredData.length) return [0, 0];
...
function StateBarChart({ data }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "w-full", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: `${isExpanded ? "h-auto" : "h-[400px]"}`, children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: isExpanded ? 800 : 400, children: /* @__PURE__ */ jsxs(BarChart, { data: sortedData, layout: "vertical", margin: { right: 20, top: 20, bottom: 40 }, children: [
      /* @__PURE__ */ jsx(CartesianGrid, { strokeDasharray: "3 3" }),
      /* @__PURE__ */ jsx(
        XAxis,
        {
...
Population: ${d.population?.toLocaleString()}`
    ...
    const regressionPlot = Plot2.plot({
...
Population: ${d.population?.toLocaleString()}`
        ...
        Plot2.linearRegressionY(cleanData, {
          x: "OBESITY_AdjPrev",
          y: "DIABETES_AdjPrev",
          strokeWidth: 2,
          stroke: "#ff6b35"
...
export { AbortionOpinionChart, stat_demographic_bar_v1_default as DemographicBarChart, DemographicDotPlot, DemographicLineChart, DualAxisChart_default as DualAxisChart, HealthScatterplot_default as HealthScatterplot, LineChart_default as LineChart, HappinessCorrelatesPanel as ScatterplotRegression, StateBarChart, TimeSeries_default as TimeSeries, TimeSeriesChart2 as TimeSeriesChart, TimeSeriesIndex_default as TimeSeriesIndex, TimeSeriesChart as TimeSeriesLine, TimeTrendDemoChart };
