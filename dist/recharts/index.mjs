import { ResponsiveContainer, LineChart, CartesianGrid, XAxis, YAxis, Tooltip, Line, ErrorBar, BarChart, Legend, Bar, Brush, ReferenceArea, Text, ScatterChart, Scatter, ReferenceLine, ComposedChart, Cell, ZAxis, Area } from 'recharts';
...
function HistogramRecharts({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "w-full", children: [
    ...
    /* @__PURE__ */ jsx(ResponsiveContainer, { width: width || "100%", height, children: /* @__PURE__ */ jsxs(BarChart, { data: histogramData, margin: { top: 20, right: 30, left: 20, bottom: 60 }, children: [
      /* @__PURE__ */ jsx(CartesianGrid, { strokeDasharray: "3 3" }),
      /* @__PURE__ */ jsx(
        XAxis,
        {
