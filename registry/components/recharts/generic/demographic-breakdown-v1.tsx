...
const DemographicBreakdown: React.FC<DemographicBreakdownProps> = ({ data }) => {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto border rounded-lg bg-card text-card-foreground shadow-sm">
      <div className="flex flex-col space-y-1.5 p-6">
        <h3 className="text-2xl font-semibold leading-none tracking-tight">{data.clean_title}</h3>
      ...
      <div className="flex flex-col items-start p-6 pt-0 text-sm text-muted-foreground">
